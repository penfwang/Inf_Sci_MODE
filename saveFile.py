...
def savetime(randomSeeds, dataSetName, running_30):
    fileName1=str(randomSeeds) + 'time'+ dataSetName + '.txt'
...
def saveAllfeature6(randomSeeds, dataSetName, error_average):
    fileName1= str(randomSeeds)+'error_average' + dataSetName
    np.save(fileName1, error_average)
    return

def saveAllfeature7(randomSeeds, dataSetName, size_average):
    fileName1= str(randomSeeds)+'size_average' + dataSetName
    np.save(fileName1, size_average)
    return

def saveAllfeature8(randomSeeds, dataSetName, hy):
    fileName1= str(randomSeeds)+'hy' + dataSetName
    np.save(fileName1, hy)
    return
